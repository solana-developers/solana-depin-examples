...
use clap::ArgMatches;
use clap::Command;
use dephy_decharge_controller::message::DephyDechargeMessage;
use dephy_decharge_controller::message::DephyDechargeMessageRequestPayload;
use dephy_decharge_controller::message::DephyDechargeStatus;
use dephy_decharge_controller::message::DephyDechargeStatusReason;
use nostr::Keys;
use nostr::Timestamp;
...
fn parse_args() -> Command {
    Command::new("dephy-decharge-controller-cli")
        .arg_required_else_help(true)
        .about("Dephy decharge controller")
...
async fn cli(args: &ArgMatches) {
    ...
    let payload = serde_json::to_string(&DephyDechargeMessageRequestPayload {
        user: user.clone(),
        nonce: *nonce,
    ...
    client
        .send_event(&machine_pubkey.to_hex(), &DephyDechargeMessage::Request {
            to_status: DephyDechargeStatus::Working,
