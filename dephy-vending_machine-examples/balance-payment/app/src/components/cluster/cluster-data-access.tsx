...
const index = import.meta.env.VITE_NETWORK === "devnet" ? 0 : 1;  // default is local if `VITE_NETWORK` env not provided

const clusterAtom = atomWithStorage<Cluster>('solana-cluster', defaultClusters[index])
